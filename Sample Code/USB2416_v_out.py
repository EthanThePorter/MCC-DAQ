...
def run_example():
    ...
    try:
        ...
        while a_out_volts <= 10:
            ...
            ul.v_out(board_num, channel_num, ULRange.BIP10VOLTS, a_out_volts)
            txt = "setting AOut{:d} to {:.1f} volts."
            print(txt.format(channel_num, a_out_volts))
            a_out_volts += 0.1
            sleep(.5)
